...
这种节奏带来的挑战是项目外的学习和项目中德实施比较难结合起来，你会发现总有重重原因无法实施这些看似先进的技术，要么是项目时间紧任务重我们要保守的技术选型，要么就是客户没钱没基础一切从零搭建成本太高。这是事实，也是现状。
...
如果说 ThoughtWorks 是一个愿景类公司，阿里巴巴的定位则要更侧重商业一些。可以预见在新的岗位上会有更高强度的工作节奏，和更关注真实用户的产品。希望能在阿里巴巴成为一个在云计算领域有一定影响力的人，有着扎实的基本功，出色的沟通表达能力，和宽阔的技术视野。这一切，都是要努力才能换来的。